...
public:
    ImageProjection():nh("~"){
        ...
        pubSegmentedCloudInfo = nh.advertise<lso::cloud_info> ("/segmented_cloud_info", 1);
...
int main(int argc, char** argv){
    ...
    google::SetLogFilenameExtension("image");
    FLAGS_stderrthreshold = google::INFO;
    FLAGS_colorlogtostderr = true;
    LOG(INFO) << ">>>>>>> Image get start";
