...
////点对点的优化icp位姿，残差三个自由度，待优化的量六个自由度
//class ceres_icp{
//public:
//    template<typename T>
...
//    tempfile.open("/home/qh/input.txt");
//    pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud(new pcl::PointCloud<pcl::PointXYZ>());
//    pcl::PointCloud<pcl::PointXYZ>::Ptr targetCloud(new pcl::PointCloud<pcl::PointXYZ>());
//    int pNums;
//    tempfile >> pNums;
//    for (int i = 0; i < pNums; i++) {
//        pcl::PointXYZ tempSourcePoint;
//        pcl::PointXYZ tempTargetPoint;
//        tempfile >> tempSourcePoint.x
//                 >> tempSourcePoint.y
//                 >> tempSourcePoint.z
//                 >> tempTargetPoint.x
//                 >> tempTargetPoint.y
//                 >> tempTargetPoint.z;
//        sourceCloud->push_back(tempSourcePoint);
//        targetCloud->push_back(tempTargetPoint);
//    }
//
//    cout << sourceCloud->size() << endl;
//
//    //耗时统计
...
//        p1[0] = sourceCloud->points[i].x;
//        p1[1] = sourceCloud->points[i].y;
//        p1[2] = sourceCloud->points[i].z;
//        p2[0] = targetCloud->points[i].x;
//        p2[1] = targetCloud->points[i].y;
//        p2[2] = targetCloud->points[i].z;
