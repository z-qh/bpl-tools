...
def getPR():
    ...
    acc_pr_path = "/home/qh/YES/dlut/Daquan16/acc_pr.pkl"
    app_pr_path = "/home/qh/YES/dlut/Daquan16/app_pr.pkl"
    accPR = {}
    appPR = {}
    ...
    acc_full_topo = Base.GetAccFullTopo(acc_fulltopo_path="/home/qh/YES/dlut/Daquan16/acc_full_topo.pkl")
    acc_full_topo_connect = Base.GetFullTopoConnectInfo(connect_path="/home/qh/YES/dlut/Daquan16/acc_connect16.pkl")
    app_full_topo = Base.GetAppFullTopo(app_full_topo_path="/home/qh/YES/dlut/Daquan16/app_full_topo.pkl")
    app_full_topo_connect = Base.GetFullTopoConnectInfo(connect_path="/home/qh/YES/dlut/Daquan16/app_connect16.pkl")
    for sim_map in sim_map_list:
...
if __name__ == "__main__":
    ...
    Base.plot_muliti_pr(accpr, apppr, row_size_=1,
                        title="2021-01-16-Bag: ours VS appearance-based-method",
                        save_path="/home/qh/YES/dlut/Daquan16/Test2.png")
