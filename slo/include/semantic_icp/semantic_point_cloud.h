...
template <typename PointT, typename SemanticT> class SemanticPointCloud {
public:
    ...
    void addSemanticCloud(SemanticT label, PointCloudPtr cloud_ptr, bool computeKd = true, bool computeCov = true);
