// Generated by gencpp from file gnss_driver/gps_navi_msg.msg
// DO NOT EDIT!


#ifndef GNSS_DRIVER_MESSAGE_GPS_NAVI_MSG_H
#define GNSS_DRIVER_MESSAGE_GPS_NAVI_MSG_H
...
struct gps_navi_msg_
{
  ...
  typedef boost::shared_ptr< ::gnss_driver::gps_navi_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gnss_driver::gps_navi_msg_<ContainerAllocator> const> ConstPtr;

}; // struct gps_navi_msg_

typedef ::gnss_driver::gps_navi_msg_<std::allocator<void> > gps_navi_msg;

typedef boost::shared_ptr< ::gnss_driver::gps_navi_msg > gps_navi_msgPtr;
typedef boost::shared_ptr< ::gnss_driver::gps_navi_msg const> gps_navi_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gnss_driver::gps_navi_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gnss_driver::gps_navi_msg_<ContainerAllocator1> & lhs, const ::gnss_driver::gps_navi_msg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gnss_driver::gps_navi_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gnss_driver::gps_navi_msg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gnss_driver::gps_navi_msg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gnss_driver::gps_navi_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x43097861a26f8aceULL;
  static const uint64_t static_value2 = 0x927b45fc1f7e2291ULL;
};

template<class ContainerAllocator>
struct DataType< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "gnss_driver/gps_navi_msg";
  }
...
template<class ContainerAllocator>
struct Definition< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gnss_driver::gps_navi_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gnss_driver::gps_navi_msg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // GNSS_DRIVER_MESSAGE_GPS_NAVI_MSG_H
