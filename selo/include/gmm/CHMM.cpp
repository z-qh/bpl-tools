...
double CHMM::Decode(vector<double*>& seq, vector<int>& state)
{
	...
	// Recursion
	for ( t = 1; t < size; t++)  //��ÿһ���۲⣬������ÿ��״̬�ĵ�ǰ����ۼӸ���
	{
...
void CHMM::Init(const char* sampleFileName)
{
	...
	sampleFile.read((char*)&dim, sizeof(int));   //��ȡ����ά��
	assert(size >= 3);
	assert(dim == m_stateModel[0]->GetDimNum());

	//����Ϊ�������ͣ���һ��״̬�ĳ�ʼ����Ϊ0.5, ����״̬�ĳ�ʼ����֮��Ϊ0.5,
	//ÿ��״̬��������ת�Ƹ���Ϊ0.5, ����һ��״̬��ת�Ƹ���Ϊ0.5.
	//�˴��ĳ�ʼ����Ҫ�ǶԻ�ϸ�˹ģ�ͽ��г�ʼ��
	for ( i = 0; i < m_stateNum; i++)
	{
		// The initial probabilities
	...
	{
		int seq_size = 0;
		sampleFile.read((char*)&seq_size, sizeof(int));  //���еĳ���

		double r = float(seq_size)/float(m_stateNum); //ÿ��״̬��r��dimά����������
...
void CHMM::Train(const char* sampleFileName)
{
	...
	while (loop)
	{
		...
		for ( i = 0; i < size; i++)
		{
			...
			currL += LogProb(Decode(seq, state)); //Viterbi����
...
void CHMM::TextTransform(const char* InputText, const char * OutputBinaryText)
{
	...
	int seq_num = 0;  //�����г��ȣ�int��
	int dim = 0;      //����ά����int��
    int seq_size = 0; //�������а�������������int��
    ...
    double *pt_feature;
	pt_feature = new double[dim];   //�������ͷ��ڴ棡����
